    ...
    <DashboardLayout user={user} onLogout={onLogout}>
      <div className="animate-in">
        <div style={{ marginBottom: 20 }}>
          ...
          >
            Health intelligence and system metrics
          </p>
        </div>
        ...
        >
          ...
          <Card>
            ...
            >
              Disease Trend (Malaria)
            </h3>

            <div style={{ marginTop: 8 }}>
              <LineSparkChart
                data={[320, 450, 280, 580, 420, 690, 540, 780, 620]}
                color={C.danger}
                height={70}
              />
            </div>
          ...
          >
            ...
            >
              {[
                ...
                {
                  name: "Hospital Utilization",
                  icon: "🏥",
                  date: "April 2025",
                },
                {
                  name: "Vaccine Coverage Report",
                  icon: "💉",
                  date: "2025",
                },
              ].map((r) => (
